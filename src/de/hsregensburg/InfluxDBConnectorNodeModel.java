...
/**
 * This is the model implementation of InfluxDBConnector.
...
public class InfluxDBConnectorNodeModel extends NodeModel {
    ...
    private static final NodeLogger logger = NodeLogger
            .getLogger(InfluxDBConnectorNodeModel.class);
    ...
    private final SettingsModelIntegerBounded m_count =
        new SettingsModelIntegerBounded(InfluxDBConnectorNodeModel.CFGKEY_COUNT,
                    InfluxDBConnectorNodeModel.DEFAULT_COUNT,
                    Integer.MIN_VALUE, Integer.MAX_VALUE);
    
    private final SettingsModelString m_database_uri =
    		new SettingsModelString(InfluxDBConnectorNodeModel.CFGKEY_DATABASE_URI, "");
    
    private final SettingsModelString m_database_username =
    		new SettingsModelString(InfluxDBConnectorNodeModel.CFGKEY_DATABASE_USERNAME, "");
    
    private final SettingsModelString m_database_password =
    		new SettingsModelString(InfluxDBConnectorNodeModel.CFGKEY_DATABASE_PASSWORD, "");
    
    private final SettingsModelString m_database_name =
    		new SettingsModelString(InfluxDBConnectorNodeModel.CFGKEY_DATABASE_NAME, "");
    
    private final SettingsModelString m_database_query =
    		new SettingsModelString(InfluxDBConnectorNodeModel.CFGKEY_DATABASE_QUERY, "");
    /**
