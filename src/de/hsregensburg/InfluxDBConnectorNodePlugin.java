 ...
 * @author pasiem
 */
public class InfluxDBConnectorNodePlugin extends Plugin {
    // The shared instance.
    private static InfluxDBConnectorNodePlugin plugin;

    /**
     * The constructor.
     */
    public InfluxDBConnectorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static InfluxDBConnectorNodePlugin getDefault() {
        return plugin;
    }
